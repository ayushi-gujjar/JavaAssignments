...
public class StudentUtil {
    ...
    public static List<Student> createStudent() {
        ...
        Student student4 = new Student(144, "Murali Gowda", 18, "Male", "Electrical", 2018, 80.0);
        students.add(student4);

        Student student5 = new Student(155, "Nima Roy", 19, "Female", "Textile", 2016, 70.0);
        students.add(student5);

        Student student6 = new Student(166, "Iqbal Hussain", 18, "Male", "Security", 2016, 70.0);
        students.add(student6);

        Student student7 = new Student(177, "Manu Sharma", 16, "Male", "Chemical", 2018, 70.0);
        students.add(student7);

        Student student8 = new Student(188, "Wang Liu", 20, "Male", "Computer Science", 2015, 80.0);
        students.add(student8);

        Student student9 = new Student(199, "Amelia Zoe", 18, "Female", "Computer Science", 2016, 85.0);
        students.add(student9);

        Student student10 = new Student(200, "Jaden Dough", 18, "Male", "Security", 2015, 82.0);
        students.add(student10);

        Student student11 = new Student(211, "Jasna Kaur", 20, "Female", "Electronic", 2019, 83.0);
